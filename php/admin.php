...
//Insert query
$query1="";$query="";
$query1="INSERT INTO admin (name, email,password,designation,edu,area_interest,school,time_stamp) VALUES ('$name','$email', '$password','$designation','$edu','$area_interest','$school','$date')";
