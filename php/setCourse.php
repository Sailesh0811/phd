...
$query="Insert into staffcourse (candidate_email,staff_email,subject1,subject2,subject3,subject4,subject5,subject6,upload,approve) values('$to_email','$from','$subject1','$subject2','$subject3','$subject4','$subject5','$subject6','1','0')";
